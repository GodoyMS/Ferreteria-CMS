...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit_checkout">
   </div>
